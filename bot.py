...
1. List their last 10 game logs for {stat} with realistic values based on their known season form.
1. List last 5 head-to-head games vs today’s opponent for this stat.
1. Note injury status and any relevant team context.
1. Project the stat and give a clear over/under verdict.
